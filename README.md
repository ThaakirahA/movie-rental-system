...
This section demonstrates the implementation of a service layer and REST API architecture for the Aura Reels Movie Rental System.

#### ⚙️ Service Layer

Service classes were implemented to encapsulate business logic and interact with the repository layer. The following services were created:

- MovieService
- UserService
- RentalService

The service layer validates inputs, enforces business rules, and separates application logic from persistence logic.

#### 🌐 REST API

RESTful API endpoints were implemented using Express.js to expose system functionality.
